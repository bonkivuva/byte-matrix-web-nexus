  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 font-roboto transition-all duration-700 relative overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/3 left-1/4 w-80 h-80 bg-gradient-to-r from-indigo-400/15 to-blue-400/15 rounded-full blur-2xl animate-float"></div>
        <div className="absolute bottom-1/4 right-1/3 w-72 h-72 bg-gradient-to-l from-emerald-400/15 to-teal-400/15 rounded-full blur-2xl animate-float" style={{ animationDelay: '3s' }}></div>
      </div>
          ...
          <div className="flex items-center justify-between">
            <Link to="/" className="flex items-center space-x-3 group">
              <img
                ...
                className="h-20 w-auto drop-shadow-2xl transition-all duration-500 group-hover:scale-110 group-hover:drop-shadow-3xl"
                loading="eager"
                style={{
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-20 animate-fade-in">
              ...
              <h1 className="text-6xl lg:text-8xl font-bold mb-10 tracking-tight bg-gradient-to-r from-gray-900 via-blue-800 to-purple-800 dark:from-white dark:via-blue-200 dark:to-purple-200 bg-clip-text text-transparent">
                Ready to Transform?
              </h1>
              <p className="text-2xl lg:text-3xl text-gray-600 dark:text-gray-300 font-light max-w-5xl mx-auto leading-relaxed">
                Connect with our innovation experts today. We're here to elevate your technology experience to extraordinary heights.
              </p>
              <div className="w-32 h-2 bg-gradient-to-r from-blue-500 via-purple-500 to-indigo-500 mx-auto mt-10 rounded-full shadow-lg"></div>
            </div>

            {/* Enhanced Working Hours Card */}
            <div className="mb-20 animate-slide-up">
              <Card className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl border-0 shadow-2xl hover:shadow-3xl transition-all duration-700 max-w-lg mx-auto hover:-translate-y-2 hover:scale-105">
                <CardContent className="p-12 text-center">
                  <div className="w-20 h-20 bg-gradient-to-br from-green-500 via-emerald-500 to-teal-600 rounded-3xl flex items-center justify-center mx-auto mb-8 shadow-xl">
                    <Clock className="h-10 w-10 text-white" />
                  </div>
                  <h3 className="text-3xl font-semibold text-gray-800 dark:text-white mb-6">Working Hours</h3>
                  <div className="space-y-4 text-gray-600 dark:text-gray-300">
                    <p className="font-medium text-xl">Monday - Saturday</p>
                    <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-2xl p-6 mb-6">
                      <p className="text-3xl font-bold text-blue-600 dark:text-blue-400">9:00 AM - 6:00 PM</p>
                    </div>
                    <div className="text-lg opacity-80 bg-gray-50 dark:bg-gray-800 rounded-xl p-4">
              ...
              {[
                {
                  ...
                  description: "Get instant support and quick responses from our expert team",
                ...
                },
                {
                  icon: Mail,
                  title: "Email Us",
                  description: "Send us your detailed requirements and get comprehensive solutions",
                ...
                <Card
                  key={index}
                  className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl border-0 shadow-2xl hover:shadow-3xl transition-all duration-700 hover:-translate-y-4 hover:scale-105 overflow-hidden group animate-scale-in"
                ...
                >
                  ...
                  <CardContent className="p-0 relative z-10">
                    ...
                    <div className="p-10 text-center">
                      <div className={`w-20 h-20 bg-gradient-to-br ${contact.gradient} rounded-3xl flex items-center justify-center mx-auto mb-8 shadow-2xl group-hover:scale-125 group-hover:shadow-3xl transition-all duration-500`}>
                        <contact.icon className="h-10 w-10 text-white" />
                      </div>
                      <h3 className="text-3xl font-semibold text-gray-800 dark:text-white mb-4">{contact.title}</h3>
                      <p className="text-gray-600 dark:text-gray-300 mb-8 font-light leading-relaxed text-lg">{contact.description}</p>
                      <a
                        href={contact.href}
                        className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-200 font-medium text-xl transition-colors duration-300 break-all hover:underline"
                      >
                        {contact.contact}
                      </a>
                    </div>
            ...
            <div className="text-center mb-20 animate-fade-in">
              <div className="mb-12">
                ...
                <h2 className="text-5xl lg:text-6xl font-bold mb-8 bg-gradient-to-r from-gray-900 via-purple-800 to-pink-800 dark:from-white dark:via-purple-200 dark:to-pink-200 bg-clip-text text-transparent">
                  🚀 Innovation in Motion!
                </h2>
                <p className="text-2xl text-gray-600 dark:text-gray-300 font-light max-w-5xl mx-auto mb-10 leading-relaxed">
              ...
              <div className="flex flex-wrap justify-center gap-8 mb-12">
                <a
                  ...
                  className="group flex items-center px-10 py-5 bg-black/90 hover:bg-black text-white rounded-2xl transition-all duration-500 hover:scale-110 shadow-2xl hover:shadow-3xl backdrop-blur-sm transform hover:-translate-y-2"
                >
                  <svg className="w-6 h-6 mr-4 group-hover:animate-pulse" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex items-center px-10 py-5 bg-blue-600/90 hover:bg-blue-700 text-white rounded-2xl transition-all duration-500 hover:scale-110 shadow-2xl hover:shadow-3xl backdrop-blur-sm transform hover:-translate-y-2"
                >
                  <svg className="w-6 h-6 mr-4 group-hover:animate-pulse" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex items-center px-10 py-5 bg-gradient-to-r from-purple-600/90 to-pink-600/90 hover:from-purple-700 hover:to-pink-700 text-white rounded-2xl transition-all duration-500 hover:scale-110 shadow-2xl hover:shadow-3xl backdrop-blur-sm transform hover:-translate-y-2"
                >
                  <svg className="w-6 h-6 mr-4 group-hover:animate-pulse" fill="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-xl text-blue-600 dark:text-blue-400 font-medium animate-pulse-slow">
            ...
            <div className="flex flex-col sm:flex-row gap-8 justify-center animate-scale-in">
              <Button
                size="lg"
                className="bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 hover:from-blue-700 hover:via-purple-700 hover:to-indigo-700 text-white px-16 py-8 text-2xl shadow-2xl hover:shadow-3xl transition-all duration-700 transform hover:-translate-y-3 hover:scale-110 font-medium rounded-2xl"
                asChild
              >
      ...
      <Button
        ...
        className="fixed bottom-8 right-8 bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 hover:from-blue-700 hover:via-purple-700 hover:to-indigo-700 text-white p-5 rounded-full shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-125 z-50"
        size="sm"
      >
